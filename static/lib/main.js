...
**Additional Information:** `;
			...
			var inclusionArray = data.composerEl.find('#inclusion-criteria').val().split("[^\\p{IsAlphabetic}0-9']+");
			var exclusionArray = data.composerEl.find('#exclusion-criteria').val().split("[^\\p{IsAlphabetic}0-9']+");
